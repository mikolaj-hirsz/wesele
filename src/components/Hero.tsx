		...
		>
			...
			<div className="relative z-10 text-center max-w-3xl">
				...
				<div className="flex items-center justify-center gap-3 mb-6">
					...
					<span className="text-romantic-muted text-sm">{dateStr}</span>
					<span className="h-px w-10 bg-romantic-primary/40" />
				</div>

				<p className="text-romantic-muted mb-8">Folwark Dajak • Koleczkowo</p>
...
/* === ORNAMENT SVG === */
/* explicit width/height already reserve layout space — no shift on load */
