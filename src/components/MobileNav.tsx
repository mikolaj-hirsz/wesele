    ...
    <header className="fixed inset-x-0 top-0 z-50 bg-romantic-surface/95 backdrop-blur border-b border-romantic-secondary">
      <div className="max-w-3xl mx-auto flex items-center justify-between px-4 py-3">
        ...
        <nav className="hidden sm:flex gap-4">
          <a href="#countdown" className="hover:text-romantic-primary">Odliczanie</a>
          <a href="#schedule" className="hover:text-romantic-primary">Harmonogram</a>
          <a href="#location" className="hover:text-romantic-primary">Miejsce</a>
          <a href="#contact" className="hover:text-romantic-primary">Kontakt</a>
        </nav>
      ...
      {open && (
        <div className="sm:hidden border-t border-romantic-secondary bg-romantic-surface">
          <ul className="flex flex-col p-4 gap-2">
            <li><a href="#countdown" onClick={() => setOpen(false)}>Odliczanie</a></li>
            <li><a href="#schedule" onClick={() => setOpen(false)}>Harmonogram</a></li>
            <li><a href="#location" onClick={() => setOpen(false)}>Miejsce</a></li>
